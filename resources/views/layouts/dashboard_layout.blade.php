...
<!-- Mirrored from admin.pixelstrap.com/zeta/theme/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Mar 2022 19:29:41 GMT -->
...
<head>
    ...
    ">
    <meta name="keywords"
        content="The most secured third party payment method">
    ...
    <link
        ...
        rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/font-awesome.css">
    <!-- ico-font-->
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/icofont.css">
    <!-- Themify icon-->
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/themify.css">
    <!-- Flag icon-->
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/flag-icon.css">
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/feather-icon.css">
    <!-- Plugins css start-->
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/scrollbar.css">
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/animate.css">
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/date-picker.css">
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/photoswipe.css">
    <!-- Plugins css Ends-->
    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="/user_assets/css/vendors/bootstrap.css">
    <!-- App css-->
...
<body>
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="notification-img bg-light-secondary"><img
                                                    src="/user_assets/images/avtar/teacher.png" alt=""></div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="notification-img bg-light-info"><img
                                                    src="/user_assets/images/avtar/teenager.png" alt=""></div>
                                            <div class="media-body">
                                    ...
                                    <li>
                                        <div class="media">
                                            <div class="notification-img bg-light-success"><img
                                                    src="/user_assets/images/avtar/chinese.png" alt=""></div>
                                            <div class="media-body">
                    ...
                    <nav class="sidebar-main">
                        ...
                        <div id="sidebar-menu" class="scroll scroll5">
                            <ul class="sidebar-links content" id="simple-bar">
                                ...
                                {{-- <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="{{route('sub', 1)}}">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                                <g>
                                ...
                                <li class="sidebar-list">
                                    <a class="sidebar-link sidebar-title link-nav" href="{{ route('view') }}">
                                        ...
                                        </svg><span>View Order Details</span>
                                    </a>
    ...
    <!-- feather icon js-->
    <script src="/user_assets/js/icons/feather-icon/feather.min.js"></script>
    <script src="/user_assets/js/icons/feather-icon/feather-icon.js"></script>
    <!-- scrollbar js-->
    <script src="/user_assets/js/scrollbar/simplebar.js"></script>
    <script src="/user_assets/js/scrollbar/custom.js"></script>
    <!-- Sidebar jquery-->
    <script src="/user_assets/js/config.js"></script>
    <!-- Plugins JS start-->
    <script src="/user_assets/js/sidebar-menu.js"></script>
    <script src="/user_assets/js/chart/knob/knob.min.js"></script>
    <script src="/user_assets/js/chart/knob/knob-chart.js"></script>
    <script src="/user_assets/js/chart/apex-chart/apex-chart.js"></script>
    <script src="/user_assets/js/chart/apex-chart/stock-prices.js"></script>
    <script src="/user_assets/js/notify/bootstrap-notify.min.js"></script>
    <script src="/user_assets/js/dashboard/default.js"></script>
    <script src="/user_assets/js/notify/index.js"></script>
    <script src="/user_assets/js/datepicker/date-picker/datepicker.js"></script>
    <script src="/user_assets/js/datepicker/date-picker/datepicker.en.js"></script>
    <script src="/user_assets/js/datepicker/date-picker/datepicker.custom.js"></script>
    <script src="/user_assets/js/photoswipe/photoswipe.min.js"></script>
    <script src="/user_assets/js/photoswipe/photoswipe-ui-default.min.js"></script>
    <script src="/user_assets/js/photoswipe/photoswipe.js"></script>
    <script src="/user_assets/js/typeahead/handlebars.js"></script>
    <script src="/user_assets/js/typeahead/typeahead.bundle.js"></script>
    <script src="/user_assets/js/typeahead/typeahead.custom.js"></script>
    <script src="/user_assets/js/typeahead-search/handlebars.js"></script>
    <script src="/user_assets/js/typeahead-search/typeahead-custom.js"></script>
    <script src="/user_assets/js/height-equal.js"></script>

    <!-- Plugins JS Ends-->
    <!-- Theme js-->
    <script src="/user_assets/js/script.js"></script>
    <script src="/user_assets/js/theme-customizer/customizer.js"></script>
    <!-- login js-->
    <!-- Plugin used-->
